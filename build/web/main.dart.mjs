...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1484: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1484(f,arguments.length,x0,x1) }),
      _1485: o => {
      ...
      _1511: (o, p) => p in o,
      _1512: (o, p) => o[p],
      _1515: () => new XMLHttpRequest(),
      _1516: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1518: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1519: (x0,x1) => x0.send(x1),
      _1520: x0 => x0.send(),
      _1546: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1546(f,arguments.length,x0) }),
      _1547: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1548: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1548(f,arguments.length,x0) }),
      _1553: x0 => new Blob(x0),
      _1554: x0 => x0.getAllResponseHeaders(),
      ...
      _1591: (o, start, length) => new BigUint64Array(o.buffer, o.byteOffset + start, length),
      ...
      _1618: Function.prototype.call.bind(DataView.prototype.getBigUint64),
      _1619: Function.prototype.call.bind(DataView.prototype.setBigUint64),
      ...
      _1700: () => globalThis.XMLHttpRequest.DONE,
      _1706: x0 => x0.readyState,
      _1713: x0 => x0.status,
      _1715: (x0,x1) => { x0.responseType = x1 },
      _1716: x0 => x0.responseType,
      _1717: x0 => x0.response,
      _3437: () => globalThis.window,
